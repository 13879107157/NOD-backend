...
const createPlatform = async (req, res) => {
    try {
        const { platformGroupId, platformTypeId, name, description, order, matchRule, exclusionRule } = req.body;
        console.log({ platformGroupId, platformTypeId, name, description, order, matchRule, exclusionRule });
...
const updatePlatform = async (req, res) => {
    try {
        const id = req.params.id;
        const { platformGroupId, platformTypeId, name, description, matchRule, order, exclusionRule } = req.body;
